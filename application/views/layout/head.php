...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo base_url('assets/dist/img/logo.png') ?>"
                width="20%">
        </div>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">LEMBAGA SERTIFIKASI PROFESI INFORMATIKA</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-widget="#" href="#" role="button">
                         <i class="fas fa-user"> Hi, <?php echo ucwords($this->session->userdata('nama_user')) ?></i>
                    </a>
                </li>
            </ul>
        </nav>
